            ...
            <div class="row">
              <div class="col-md-6">
                <div class="post-entry-1">
                  <a href="post-single"><img src="images/img_h_1.jpg" alt="Image" class="img-fluid"></a>
                  <h2><a href="blog-single">News Needs to Meet Its Audiences Where They Are</a></h2>
          ...
          <div class="col-12">
            <div class="copyright">
                <p>
                    ...
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://vicsystems.com.ng" target="_blank" >vicSystems</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
            </div>
          </div>
