      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 single-content">
            ...
            <p class="mb-5">
              <img src="{{ $single_post->image_url}}" alt="Image" class="img-fluid">
            </p>  
            <h1 class="mb-4">
              {{ $single_post->title}}}
            </h1>
          ...
          <div class="col-lg-3 ml-auto">
            ...
            <div class="trend-entry d-flex">
              <div class="number align-self-start">{{$loop->iteration}}</div>
              <div class="trend-contents">
                <h2><a href="{{ route('blog.single', $post->id)}}">{{ $post->title}}</a></h2>
                <div class="post-meta">
                  <span class="d-block"><a href="#">{{$post->user->name}}</a> in <a href="#">News</a></span>
                  <span class="date-read">{{$post->created_at->diffForHumans()}} <span class="mx-1">&bullet;</span> 3 min read <span class="icon-star2"></span></span>
                </div>
              </div>
            </div>
            ...
            <p>
              <a href="{{ route('blog.home')}}" class="more">See All Popular <span class="icon-keyboard_arrow_right"></span></a>
            </p>
          </div>
